...
export class TasksFormComponent implements OnInit {
  ...
  readonly fields: Array<PoDynamicFormField> = [
    ...
    { property: 'title', required: true, showRequired: true, label: 'Título', gridLgColumns: 4, gridMdColumns: 4, gridSmColumns: 12 },
  ...
  getTitle(): string {
    ...
    return this.operation === 'new' ? 'Incluir Tarefa' : 'Alterar Tarefa';
  }
